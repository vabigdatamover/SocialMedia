...
#https://stackoverflow.com/questions/61166965/pytrends-is-only-implemented-in-city-level-for-usa-and-without-geocode
...
class MyTrendReq(TrendReq):
    ...
    def interest_by_region(self, resolution='REGION', inc_low_vol=False,
                           inc_geo_code=False):
...
if __name__=="__main__":
    ...
    region_df = pytrend.interest_by_region(resolution='REGION', inc_low_vol=True)    
